...
- [Unnecessary Knowledge](#unnecessary-knowledge)
...
<details><summary>Image showing nodes branching</summary><img src=/pix/centralized-decentralized.avif></details>

The more algorithmically and systematically a platform is designed, the more impressive it looks from the outset. It may mimick a living breathing society and replicate the congregation of people in a town square. 

But beyond the crowds of people, lies a heart that must keep beeping if the above 2 criterion are truly met.

A 'central' authority responsible for safeguarding users, enforcing rules and the general maintenance of  the town center.
...
But software services don't need the Big Man...
